...
public class MenuActivityScreenTest {
    ...
    public static final String TEA_NAME = "Chamomile Tea";

    @Rule
    public ActivityTestRule<MenuActivity> testRule = new ActivityTestRule<>(MenuActivity.class);
    ...
    public void clickGridViewItem_OpensOrderActivity() {
        ...
        onData(anything()).inAdapterView(withId(R.id.tea_grid_view)).atPosition(5).perform(click());
